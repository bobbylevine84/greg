...
<!--for local scripts-->
  $(document).ready(function() {
    ...
    $('#copy_from').on('change', function() {
      var url = '{{ URL::route('templates.copy') }}';
      var tid = $(this).val();
      window.location.href = url + '/' + tid;
    });
...
example, ‘JohnsonField‐2eth‐1cell‐1ser’.</i>
              ...
              <div class="form-group">
                ...
                @if($groups)
                  @foreach($groups as $rid => $rnm)
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        {{ Form::checkbox('grp_ids[]', $rid, false, [ 'class' => 'square-red' ]) }} {{ $rnm }}
                      </div>
                    </div>
        ...
        <div class="box-body">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Serial Number Required? &nbsp; <small class="carrier-flds hide-me"><span class="fa fa-star red"></span></small></label><br/>
