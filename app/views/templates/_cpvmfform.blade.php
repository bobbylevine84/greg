...
@endif
  ...
  {{ Form::hidden('vmfkeys['.$r->ft_fld_name . $ft_fld_part.'][ftid]', $ft_id, [ 'class' => 'mvfid_' . $ft_id ] ) }}
  ...
  @if( $r->hasChildren() )
  	...
  	{{ View::make('templates._cpvmfchildform', [ 'records' => $r->children(), 'ft_lbl_part' => $ft_lbl_part, 'ft_fld_part' => $ft_fld_part ] ) }}
