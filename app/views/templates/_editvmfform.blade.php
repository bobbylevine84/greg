...
@endif
  ...
  {{ Form::hidden('vmfkeys['.$r->ft_fld_name . $ft_fld_part.'][ftid]', $r->ft_id, [ 'class' => 'mvfid_' . $r->ft_id ] ) }}
  {{ Form::hidden('vmfkeys['.$r->ft_fld_name . $ft_fld_part.'][label]', $r->ft_label . $ft_lbl_part ) }}
  {{ Form::hidden('vmfkeys['.$r->ft_fld_name . $ft_fld_part.'][tftid]', $r->_id ) }}
  ...
  @if( $r->hasChildren() )
	...
	{{ View::make('templates._editvmfchildform', [ 'records' => $r->children(), 'ft_lbl_part' => $ft_lbl_part, 'ft_fld_part' => $ft_fld_part ] ) }}
