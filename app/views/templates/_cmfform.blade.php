...
@endif
  ...
  {{ Form::hidden('cmfkeys['.$r->ft_fld_name . $ft_fld_part.'][ftid]', $r->_id, [ 'class' => 'mcfid_' . $r->_id ] ) }}
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label>Start &nbsp; <small></small></label>
          {{ Form::text( 'cmf['.$r->ft_fld_name . $ft_fld_part.']['.$fld.']' , null, [ 'id' => 'start_'.$r->ft_fld_name . $ft_fld_part, 'placeholder' => 'Start '.$r->ft_label . $ft_lbl_part, 'class' => 'form-control' ]) }}
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label>End &nbsp; <small></small></label>
          {{ Form::text( 'cmf['.$r->ft_fld_name . $ft_fld_part.']['.$fld2.']' , null, [ 'id' => 'end_'.$r->ft_fld_name . $ft_fld_part, 'placeholder' => 'End '.$r->ft_label . $ft_lbl_part, 'class' => 'form-control' ]) }}
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label>{{ $r->ft_label . $ft_lbl_part }} &nbsp; <small></small></label>
          {{ Form::text( 'cmf['.$r->ft_fld_name . $ft_fld_part.']['.$fld.']' , null, [ 'id' => $r->ft_fld_name . $ft_fld_part, 'placeholder' => $r->ft_label . $ft_lbl_part, 'class' => 'form-control' ]) }}
          <span name="emsg-{{ 'cmf['.$r->ft_fld_name . $ft_fld_part.']['.$fld.']' }}" class="validation-error hideme"></span>
      </div>
    </div>
    <?php $kounter++; ?>
  ...
  @if( $r->ft_type == 'Drop-down' )
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label>{{ $r->ft_label . $ft_lbl_part }} &nbsp; <small></small></label>
          {{ Form::select( 'cmf['.$r->ft_fld_name . $ft_fld_part.']['.$fld.']' , $options, null, [ 'id' => $r->ft_fld_name . $ft_fld_part, 'class' => 'form-control' ] ) }}
          <span name="emsg-{{ 'cmf['.$r->ft_fld_name . $ft_fld_part.']['.$fld.']' }}" class="validation-error hideme"></span>
      </div>
    </div>
    <?php $kounter++; ?>
  ...
  @if( $r->ft_type == 'Text-area' )
    <div class="col-md-12">
      <div class="form-group">
        <label>{{ $r->ft_label . $ft_lbl_part }} &nbsp; <small></small></label>
          {{ Form::textarea( 'cmf['.$r->ft_fld_name . $ft_fld_part.'][txtvalue]' , null, [ 'id' => $r->ft_fld_name . $ft_fld_part, 'rows' => '3', 'placeholder' => $r->ft_label . $ft_lbl_part, 'class' => 'form-control' ]) }}
  ...
  @if( $r->hasChildren() )
  	...
  	{{ View::make('templates._cmfchildform', [ 'records' => $r->children(), 'ft_lbl_part' => $ft_lbl_part, 'ft_fld_part' => $ft_fld_part ] ) }}
