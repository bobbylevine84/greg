...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'templates.store', 'method' => 'post' ) ) }}
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Copy Template</h3> &nbsp; (<small><span class="fa fa-star red"> required field</span></small>)
          </div><!-- /.box-header -->
          <div class="box-body">
...
example, ‘JohnsonField‐2eth‐1cell‐1ser’.</i>
        ...
        <div class="box-body">
            ...
            <span id="vendor_model_ftrs">
              {{ View::make('templates._cpvmfform', [ 'records' => $record->vendormodelfeatures()->isLevel1()->get(), 'vmodel' => $record->vendor_model_id, 'ft_lbl_part' => $ft_lbl_part, 'ft_fld_part' => $ft_fld_part ] ) }}
            </span>
        ...
        <div class="box-body">
            ...
            <span id="carrier_model_ftrs">
              {{ View::make('templates._cpcmfform', [ 'records' => $record->carriermodelfeatures()->isLevel1()->get(), 'cmodel' => $record->carrier_model_id, 'ft_lbl_part' => $ft_lbl_part, 'ft_fld_part' => $ft_fld_part ] ) }}
            </span>
