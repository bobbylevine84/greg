...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'carrier.store', 'method' => 'post', 'autocomplete' => 'off') ) }}
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Create New Carrier</h3> &nbsp; (<small><span class="fa fa-star red"> required field</span></small>)
          </div><!-- /.box-header -->
          <div class="box-body">
