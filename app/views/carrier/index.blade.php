  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          {{ Form::open( array('id' => 'frmSrch', 'route' => 'carrier.index', 'method' => 'post') ) }}
            ...
            <div class="box-footer" style="padding: 10px 15px;">
              ...
              <input value="Add New" name="btnAdd" class="btn btn-success pull-right" type="button" onclick="window.location.href='{{ URL::route('carrier.create') }}'" />
            </div>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <table class="table table-bordered table-striped">
            <tr>
              <th width="75%" class="orderable" data-field="carrier_name">Carrier Name</th>
            ...
            <tr>
              ...
              <td>{{ $r->is_active }}</td>
              <td>
                <span class="glyphicon glyphicon-edit icon-action lblue" onclick="window.location.href='{{ URL::route('carrier.edit', $r->_id) }}'" title="Edit"></span> &nbsp; &nbsp; 
                <span class="glyphicon glyphicon-trash icon-action red" onclick="javascript:confirmAction('{{ URL::route('carrier.destroy', $r->_id) }}', 'Delete this record?')" title="Delete"></span>
              </td>
            </tr>
            @endforeach
