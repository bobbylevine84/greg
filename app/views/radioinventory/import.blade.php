...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'radioinventory.saveimport', 'method' => 'post', 'files' => true ) ) }}
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Vendor &nbsp; <small><span class="fa fa-star red"></span></small></label>
                  ...
                  {{ $errors->first('vendor_id', '<span class="validation-error">:message</span>') }}
              </div>
            </div>
