...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'radioinventory.store', 'method' => 'post' ) ) }}
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Create New Inventory</h3> &nbsp; (<small><span class="fa fa-star red"> required field</span></small>)
          </div><!-- /.box-header -->
          <div class="box-body">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Status</label>
                <span class="form-control" readonly>[Default - Available]</span>    
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>GUID</label>
                  {{ Form::text('GUID', null, ['id' => 'guid', 'placeholder' => 'GUID', 'class' => 'form-control']) }}
                  <span name="emsg-guid" class="validation-error hideme"></span>
              </div>
            </div>
