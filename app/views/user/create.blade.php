...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'user.store', 'method' => 'post', 'autocomplete' => 'off') ) }}
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>RUK </label>
                  <span class="form-control" disabled >{{ $myApp->RUK }}</span>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                @foreach($groups as $id => $nm)
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      {{ Form::checkbox('group_ids[]', $id, false, [ 'class' => 'square-red' ]) }} {{ $nm }}
                    </div>
                  </div>
