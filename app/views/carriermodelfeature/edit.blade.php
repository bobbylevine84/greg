...
@section('lscripts')
  ...
  var childmouldurl = '{{ URL::route('masterdata.newchildmouldcarriermodelfeature') }}';
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => [ 'masterdata.updatecarriermodelfeature', $record->_id ], 'method' => 'post' ) ) }}
        <input type="hidden" name="redirectroute" value="{{ URL::route('masterdata.carriermodelfeature') }}"/>
          ...
          <div class="box-body">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                {{ Form::select('ft_type', $ft_types, null, [ 'id' => 'ft_type', 'class' => 'form-control' ] ) }}
            ...
            @if( $record->hasChildren() )
              <?php $ck = 0; ?>
              @foreach( $record->children(false) as $r )
                {{ View::make('carriermodelfeature._childmould', [ 'rec' => $r, 'ck' => $ck, 'ft_types' => $ft_types, 'data_types' => $data_types, 'assigned_by' => $assigned_by ] ) }}
                <?php $ck++; ?>
              @endforeach
            @endif
            <!-- / showing chiildren -->
            ...
            <div class="box-footer" style="padding: 15px 15px;">
              ...
              <input value=" Back " name="btnExit" class="btn bg-gray" type="button" onclick="window.location.href='{{ URL::route('masterdata.carriermodelfeature') }}'" />
               &nbsp; &nbsp; 
