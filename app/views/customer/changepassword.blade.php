...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'customer.updatepassword', 'method' => 'post', 'autocomplete' => 'off') ) }}
        <input type="hidden" name="redirectroute" value="{{ URL::route('customer.myaccount') }}"/>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="box-footer" style="padding: 15px 15px;">
              ...
              <input value=" Back " name="btnExit" class="btn bg-gray" type="button" onclick="window.location.href='{{ URL::route('customer.myaccount') }}'" />
            </div>
