...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => 'customer.updatemyaccount', 'method' => 'post', 'autocomplete' => 'off') ) }}
        ...
        <div class="box-body">
            ...
            <div class="box-footer" style="padding: 15px 15px;">
              ...
              <input value=" Change Password " name="btnExit" class="btn bg-gray" type="button" onclick="window.location.href='{{ URL::route('customer.changepassword') }}'" />
            </div>
