  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          {{ Form::open( array('id' => 'frmSrch', 'route' => 'customer.index', 'method' => 'post') ) }}
            ...
            <div class="box-footer" style="padding: 10px 15px;">
              ...
              <input value="Add New" name="btnAdd" class="btn btn-success pull-right" type="button" onclick="window.location.href='{{ URL::route('customer.create') }}'" />
            </div>
        ...
        <div class="box-body">
          <table class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>{{ $r->is_active }}</td>
              <td>
                <span class="glyphicon glyphicon-edit icon-action lblue" onclick="window.location.href='{{ URL::route('customer.edit', $r->_id) }}'" title="Edit"></span> &nbsp; &nbsp; 
              </td>
            </tr>
            @endforeach
