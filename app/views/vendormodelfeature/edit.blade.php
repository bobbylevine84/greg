...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{ Form::model( $record, array('id' => 'frmRecord', 'route' => [ 'masterdata.updatevendormodelfeature', $record->_id ], 'method' => 'post' ) ) }}
          ...
          <div class="box-body">
            ...
            @if( $record->hasChildren() )
              ...
              @foreach( $record->children(false) as $r )
                {{ View::make('vendormodelfeature._childmould', [ 'rec' => $r, 'ck' => $ck, 'ft_types' => $ft_types, 'data_types' => $data_types, 'assigned_by' => $assigned_by ] ) }}
                <?php $ck++; ?>
              @endforeach
            @endif
            <!-- / showing chiildren -->
