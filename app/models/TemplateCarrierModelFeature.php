...
class TemplateCarrierModelFeature extends BaseModel {

/*
CREATE TABLE IF NOT EXISTS `tbl_template_carrier_model_feature` (
  `_id` int(11) NOT NULL,
...
*/
     ...
     * @var string
     */
    protected $table = 'tbl_template_carrier_model_feature';
    ...
    public function parent() {
        return TemplateCarrierModelFeature::where('ft_id', $this->ft_group_id )->where('tmpl_id', $this->tmpl_id)->get();
    }

    // Get Children
    public function children($onlyActive=true) {
        $children = TemplateCarrierModelFeature::where( 'ft_group_id', $this->ft_group_id )
