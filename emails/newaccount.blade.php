...
<table width="728" cellspacing="0" border="0" align="center" style="font-size:14px; font-family:Verdana, Arial, Helvetica, sans-serif; color:#252525;">
  ...
  <tr><td colspan="4" style="padding:0 10px;">Hello {{ $firstname }},</td></tr>

  <tr><td colspan="4" style="padding:0 10px;">&nbsp;</td></tr>

  <tr>
    <td colspan="4" style="padding:0 10px;text-indent:50px;">
      E2E welcomes you as our newest E2E Value Added Reseller. 
      Please click on this <a target="_blank" href="{{ $link }}">link</a> to continue your on boarding process. 
  ...
  <tr><td colspan="4" style="padding:0 10px;">Customer Number: {{ $custno }}</td></tr>
  <tr><td colspan="4" style="padding:0 10px;">Username : {{ $username }}</td></tr>
  <tr><td colspan="4" style="padding:0 10px;">Password : {{ $userpass }}</td></tr>
